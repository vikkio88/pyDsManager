...
from vendors.faker import AVAILABLE_LOCALES, DEFAULT_LOCALE, META_PROVIDERS_MODULES
from vendors.faker import Faker, Factory, documentor
from vendors.faker import VERSION
...
def print_doc(provider_or_field=None,
    ...
    from vendors.faker import BaseProvider
